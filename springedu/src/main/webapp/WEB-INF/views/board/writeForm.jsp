  ...
  <div class="container">
   <div class="header">
    ...
    <div class="body">
      ...
      <div>
        <div><form:label path="boardCategoryVO.cid" for="">분류</form:label></div>
        <div colspan="4">
	  ...
	  <div>
        <td colspan="5"><form:errors path="boardCategoryVO.cid"></form:errors>
      </div>
      <div>
     ...
     <div>
        ...
        <form:textarea rows="15" cols="100" style="width: 99%;" path="bcontent"/>
     </div>
     <div>
